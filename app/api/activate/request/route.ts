...
export async function POST(request: NextRequest) {
  ...
  let body: { device_name?: string; platform?: string; token_hash?: string; polling_verifier?: string }
  try {
  ...
  const { device_name, platform = 'macos', token_hash, polling_verifier } = body
